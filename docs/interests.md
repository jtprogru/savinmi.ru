...
Иногда пишу всякие поделки на Python и Golang – небольшую подборку актуальных утилит можно посмотреть на странице [Проекты](projects.md). Для своих проектов использую автоматизацию на базе GitHub Actions.
