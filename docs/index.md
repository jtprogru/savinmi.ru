...
Для связи пиши в Telegram: **[@jtprogru](https://t.me/jtprogru)** или по альтернативным каналам связи. Если же ты твердо уверен и готов созвониться, то заходи в [календарь](https://cal.com/jtprogru/main) и бронируй слот.
