...
- [Комьюнити живёт ровно настолько, насколько компания считает его работой](https://devrel.ru/komuniti-zhivet-esli-rabota) — на DevRel.ru: почему комьюнити держится не на чек-листе, а на том, считает ли компания участие в нём работой. Четыре разговора с бизнесом — про запуск, права, время участников и отчётность, — разница между мандатом и доброжелательностью, и почему 200 подписчиков канала при девяти пришедших на встречу это закономерность, а не провал вовлечения.
