...
## Инфраструктура и работа со знаниями
...
- **Avito TechPR DrinkUP** — «Запуск внутреннего SRE-комьюнити», внутреннее мероприятие Авито. Саму презентацию отдаю индивидуально по запросу, публичные материалы к докладу — [в канале](https://t.me/jtprogru_channel/4433).
...
- **[Менторство в GetMentor](https://getmentor.dev/mentor/michael-savin-1427)** — помогаю менти двигаться по их задачам, а себе прокачиваю коммуникацию.
