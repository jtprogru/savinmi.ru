...
Где и как это применялось — на странице [опыт работы](/experience/). Подтверждающие курсы и сертификаты — в разделе [сертификаты](/awards/). Что из этого превратилось в код — [проекты](/projects/).
