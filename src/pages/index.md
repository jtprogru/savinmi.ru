...
Являюсь членом программного комитета [DevOpsConf](https://devopsconf.io/) и развиваю открытый проект [**The Way of SRE**](https://jtprogru.github.io/The-Way-of-SRE/) — структурированную подборку материалов и заметок для тех, кто растёт в SRE-направлении.
...
Ты можешь обратиться ко мне с предложением о работе или за консультацией по каким-либо вопросам, относящимся к моим [интересам](/interests/) или моему [опыту](/experience/).
...
Для связи пиши в Telegram: **[@jtprogru](https://t.me/jtprogru)** или по альтернативным каналам связи. Если же ты твердо уверен и готов созвониться, то заходи в [календарь](https://calendlab.ru/c/jtprogru-getmentor) и бронируй слот.
