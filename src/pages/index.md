...
Отдельно — менторство через [GetMentor](https://getmentor.dev/mentor/jtprogru): помогает менти двигаться по своим задачам, а мне — прокачивать навыки коммуникации и формулирования.

Подробнее — [опыт работы](/experience/), [навыки](/skills/), [проекты](/projects/) и [доклады с публикациями](/publications/).
