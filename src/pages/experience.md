...
Главный ответственный за надежность и доступность молодого и амбициозного облака.

Стэк: *самый разнообразный*
...
Запустил внутреннее комьюнити SRE в крупнейшем классифайде страны. Провел ресерч и подготовил базу для запуска Digital Immune System.
